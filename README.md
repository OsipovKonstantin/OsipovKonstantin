## 💫 Java разработчик
Привет!👋 Приветствую на своей странице. Я Java-разработчик из Севастополя с опытом 1 год. В данный момент активно ищу работу
...
| [![Shareit](https://img.shields.io/static/v1?label=&message=ShareIt&color=000605&logo=github&logoColor=FFFFFF&labelColor=000605)](https://github.com/OsipovKonstantin/java-shareit) | Java 11 (Core, Stream), Spring (Boot, Data), Hibernate, PostgreSQL, Maven, Docker, JUnit 5, Mockito, Lombok, RESTful API |
